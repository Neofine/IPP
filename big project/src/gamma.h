/**
 * @file
 * Moduł zawiera wszystkie komendy które mogą zostać wywołane w main'ie
 *
 ...
 * Podaje liczbę wolnych pól, na których w danym stanie gry gracz
 * @p player może postawić swój pionek w następnym ruchu.
 * @param[in] g       – wskaźnik na strukturę przechowującą stan gry,
 * @param[in] player  – numer gracza, liczba dodatnia niewiększa od wartości
 *                      @p players z funkcji @ref gamma_new.
 ...
 * ruchu i jest przynajmniej jedno pole przeciwnika które może zająć i nie
 * spowoduje to naruszenia zasad rozgrywki
 * @param[in] g       – wskaźnik na strukturę przechowującą stan gry,
 * @param[in] player  – numer gracza, liczba dodatnia niewiększa od wartości
 *                      @p players z funkcji @ref gamma_new.
 * @return Wartość @p true, jeśli gracz jeszcze nie wykonał w tej rozgrywce
 * złotego ruchu i jest przynajmniej jedno pole przeciwnika które może zająć i nie
 * spowoduje to naruszenia zasad rozgrywki, a @p false w przeciwnym przypadku.
 */
